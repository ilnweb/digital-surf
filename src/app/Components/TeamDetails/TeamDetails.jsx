          ...
          <div className='row g-4 align-items-center'>
            <div className='col-lg-4'>
              <div className='team-details-thumb wow fadeInUp' data-wow-delay='.6s'>
                <Image
                  src='/assets/images/team/teamDetailsThumb1_1.jpg'
                  alt='img'
                  width={355}
                  height={431}
                />
            ...
            <div className='col-lg-8'>
              <div className='team-details-content'>
                ...
                <p className='mt-3 wow fadeInUp' data-wow-delay='.9s'>
                  Kenneth Z. Burke, known as Kenneth Duva Burke, was an influential American
                  literary theorist and philosopher. Born on May 5, 1897, and passing away on
                  November 19, 1993.
                </p>
                <p className='mb-70 wow fadeInUp' data-wow-delay='1s'>
                  {' '}
                  Burke made significant contributions to the fields of rhetoric, literary
                  criticism, and philosophy. His work primarily focused on the nature of language
                  and its role in shaping human experience.
                </p>
                <div className='signature wow fadeInUp' data-wow-delay='.6s'>
                  <Image
                    src='/assets/images/team/teamDetailsSignature.png'
                    alt='img'
                    width={91}
                    height={50}
                  />
        ...
        <div className='container'>
          <div className='row'>
            ...
            <p className=' wow fadeInUp' data-wow-delay='1.9s'>
              {' '}
              Burke developed the concept of dramatism, which views human communication as a form of
              dramatic action. He introduced the pentad (act, scene, agent, agency, purpose) to
              analyze motives in communication.He emphasized the importance of identification in
              rhetoric, where persuasion is seen as the alignment of interests or the creation of a
              sense of unity between speaker and audience.
            </p>
            <p className='mb-55 wow fadeInUp' data-wow-delay='.6s'>
              Burke examined how language shapes human perception and reality. He argued that
              language is not just a tool for communication but also a framework for understanding
              the world.Burke interdisciplinary approach has influenced various fields, including
              communication studies, literary theory, sociology, and political science. His ideas on
              rhetoric and symbolic action remain foundational in understanding human communication
